    ...
    protected IOIOLooper createIOIOLooper() {
        return new BaseIOIOLooper() {
            ...
            protected void setup() throws ConnectionLostException,
                ...
                echoPin_ = ioio_.openPulseInput(new DigitalInput.Spec(35), 
                		PulseInput.ClockRate.RATE_250KHz, PulseInput.PulseMode.POSITIVE, false);
            }
    ...
    public void onStart(Intent intent, int startId) {
        ...
        if (intent != null && intent.getAction() != null
        	...
        	NotificationCompat.Builder mBuilder =
        	        ...
        	        .setContentTitle("IOIOService")
        	        .setContentText("Click to stop");
        	mBuilder.build();
        	mBuilder.setContentIntent(PendingIntent.getService(this, 0, new Intent(
